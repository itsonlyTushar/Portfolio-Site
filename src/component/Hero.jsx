...
function Hero() {
  return (
    <>
      ...
      <section>
        <div className="relative z-10 flex flex-col items-start ml-16 my-5 text-white h-full justify-center"> 
          ...
          <div className='flex'>
            <div className='border border-yellow-100 bg-green-300 hover:bg-transparent hover:text-green-300 text-[#CD9876] font-semibold text-xl rounded-full w-[16rem] py-5 px-9 cursor-pointer text-center'>
              <a 
                href={CV}
