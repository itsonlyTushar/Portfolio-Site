...
function Footer() {
  return (
    ...
    <div className='mt-56 flex  gap-7 justify-around mb-9 max-w-full'>
    ...
    <ul className='cursor-pointer w-1/3'>
        ...
        <div className='text-[#8E847F] hover:text-[#c5c1be] text-xl transition ease-in-out delay-200'>
            ...
            <li className='flex items-center hover:text-[#d1ce90] hover:transition-all my-3 overflow-hidden'>
    ...
    <div >
      <h3 className='text-[#15252D] text-xl font-semibold'>
          ...
          <i className="fa-brands fa-square-github text-6xl mt-2 mx-3 text-[#15252D] hover:text-[#2f424c] "></i>
